function(_get_ned_folders _target _property _base_dir _output)
    get_property(_visited GLOBAL PROPERTY _NED_FOLDERS_VISITED)
    if("${_target}" IN_LIST _visited)
        set(${_output} "" PARENT_SCOPE)
        return()
    endif()
    set_property(GLOBAL APPEND PROPERTY _NED_FOLDERS_VISITED "${_target}")
...
function(get_ned_folders _target _output)
    set_property(GLOBAL PROPERTY _NED_FOLDERS_VISITED "")
